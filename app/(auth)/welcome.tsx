...
const Onboarding = () => {
  ...
  return (
    <SafeAreaView className="flex h-full items-center justify-between bg-white">
      ...
      >
        <Text className="text-red-500 text-md font-outfit-bold">Skip</Text>
      </TouchableOpacity>
      ...
      <Swiper
        ...
        activeDot={<View className="w-8 h-1 mx-1 bg-red-500 rounded-full" />}
        ...
        {onboarding.map((item) => (
          <View key={item.id} className="flex items-center justify-center p-5">
            ...
            <View className="flex flex-row items-center justify-center w-full mt-10">
              <Text className="text-red-500 font-outfit-bold text-3xl mx-10 text-center">
                {item.title}
              </Text>
            </View>
