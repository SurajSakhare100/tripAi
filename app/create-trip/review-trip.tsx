  ...
  const renderReviewItem = (
    ...
    <View className="flex-row items-center justify-between bg-white p-4 rounded-xl mb-4 shadow-sm border border-neutral-100">
      <View className="flex-row items-center flex-1">
        <View className="bg-red-100 p-3 rounded-full">{icon}</View>
      ...
      >
        <MaterialIcons name="edit" size={20} color="#F75A41" />
      </TouchableOpacity>
    </View>
  );
    ...
    <SafeAreaView className="flex-1">
      <View className="p-6">
        ...
        {renderReviewItem(
          ...
          <Ionicons name="location-sharp" size={24} color="#F75A41" />,
        ...
        {renderReviewItem(
          ...
          <MaterialIcons name="people" size={24} color="#F75A41" />,
        ...
        {renderReviewItem(
          ...
          dates
            ...
            : "Not selected",
          <FontAwesome5 name="calendar-alt" size={24} color="#F75A41" />,
