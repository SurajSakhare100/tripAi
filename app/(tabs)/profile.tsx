...
const Profile = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white p-6">
      ...
      <View className="bg-red-50 p-6 rounded-xl mb-8">
        <View className="flex-row items-center mb-4">
          <View className="bg-red-200 p-4 rounded-full">
            <Ionicons name="person" size={32} color="#F75A41" />
          </View>
          <View className="ml-4">
      ...
      <View className="mb-8">
        ...
        <TouchableOpacity className="flex-row items-center justify-between bg-gray-50 p-4 rounded-xl mb-3">
          <View className="flex-row items-center">
            <Ionicons name="mail-outline" size={24} color="#F75A41" />
        ...
        <TouchableOpacity className="flex-row items-center justify-between bg-gray-50 p-4 rounded-xl">
          <View className="flex-row items-center">
            <Ionicons name="time-outline" size={24} color="#F75A41" />
